...
public:
    ...
    ClassDef(ReconstructedPosition, 532);
};
...
public:
	...
	Bool_t  is_channel_suspicious[254];
	Short_t  lone_hits_per_channel[254];
	Short_t  lone_hits_per_channel_before[254];
	Int_t  n_channels;
	Short_t  n_hits_rejected[254];
	Short_t  noise_pulses_in[254];
